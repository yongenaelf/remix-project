...
export class ThemeModule extends Plugin {
  ...
  currentTheme() {
    if (isElectron()) {
      const theme = 'https://studio.aelf.com/' + this.themes[this.active].url.replace(/\\/g, '/').replace(/\/\//g, '/').replace(/\/$/g, '')
  ...
  switchTheme(themeName) {
    ...
    if (isElectron()) {
      const theme = 'https://studio.aelf.com/' + nextTheme.url.replace(/\\/g, '/').replace(/\/\//g, '/').replace(/\/$/g, '')

...
const loadLocalPlugins = ['doc-gen', 'doc-viewer', 'etherscan', 'vyper', 'aelf', 'solhint', 'walletconnect', 'circuit-compiler', 'learneth', 'quick-dapp']
...
export class RemixAppManager extends PluginManager {
  constructor() {
    ...
    this.pluginsDirectory = 'https://raw.githubusercontent.com/yongenaelf/remix-plugins-directory/master/build/metadata.json'

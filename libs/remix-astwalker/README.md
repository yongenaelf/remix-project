...
`@remix-project/remix-astwalker` is a tool to parse AST (Abstract Syntax Tree) generated by Compiler to perform certain operations. It is used in `remix-analyzer`, `remix-debug` and in `contextualListener` plugin of Remix IDE.

...
export const RemixUiSettings = (props: RemixUiSettingsProps) => {
  ...
  const onchangeCopilotActivate = () => {
    if (!props.useCopilot) {
      ...
      props.plugin.call('terminal', 'log', { type: 'typewriterlog', value: `Copilot not activated!` })
      return
    }

    const startCopilot = async () => {
      copilotActivate(props.config, props.useCopilot, dispatch)
      props.plugin.call('terminal', 'log', { type: 'typewriterlog', value: `Copilot activated!` })
    }
